...
<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="index.html" class="logo"><i class="mdi mdi-radar"></i> <span>Bodygram</span></a>
        </div>
    </div>
        ...
        <ul class="list-inline float-right mb-0">
            ...
            <li class="list-inline-item notification-list">
                <a class="nav-link right-bar-toggle waves-light waves-effect" href="#">
                    <b class="text-white">{{\Illuminate\Support\Facades\Auth::user()->wallet}}₮ <i class=" mdi mdi-credit-card-plus"></i></b>
                </a>
            </li>
